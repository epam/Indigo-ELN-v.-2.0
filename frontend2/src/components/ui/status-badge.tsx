...
const statusBadgeVariants = cva(
  ...
  {
    variants: {
      // Keys are the ExperimentStatus values verbatim, so a status can be passed straight
      // through — and `satisfies` is what holds them to that rather than a comment.
      variant: {
