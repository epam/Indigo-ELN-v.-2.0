...
import { ExperimentActions, UndoRedoButtons } from '@/components/experiments/details/experiment-actions';
import { tabSlugs } from '@/components/experiments/details/experiment-template';
