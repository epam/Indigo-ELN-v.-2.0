...
public class PrintResource {
    ...
    public ResponseEntity<byte[]> download(
            @Parameter(description = "File name") @PathParam("fileName") String fileName
    ) {
        String fn = fileName;
    ...
    @Operation(summary = "Open experiment pdf preview")
    @RequestMapping(
            method = RequestMethod.GET,
            path = "/project/{projectId}/notebook/{notebookId}/experiment/{experimentId}",
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    public ResponseEntity<byte[]> createExperimentPdf(@Parameter(description = "project id") @PathVariable String projectId,
                                                      ...
                                                      @Parameter(description = "print params") PrintRequest printRequest) {
    ...
    @Operation(summary = "Open project pdf preview")
    @RequestMapping(
            method = RequestMethod.GET,
            path = "/project/{projectId}",
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    public ResponseEntity<byte[]> createProjectPdf(@Parameter(description = "project id") @PathVariable String projectId,
                                                   @Parameter(description = "print params") PrintRequest printRequest) {
    ...
    @Operation(summary = "Open notebook pdf preview")
    @RequestMapping(
            method = RequestMethod.GET,
            path = "/project/{projectId}/notebook/{notebookId}",
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    public ResponseEntity<byte[]> createNotebookPdf(@Parameter(description = "project id") @PathVariable String projectId,
                                                    @Parameter(description = "notebook id") @PathVariable String notebookId,
                                                    @Parameter(description = "print params") PrintRequest printRequest) {
