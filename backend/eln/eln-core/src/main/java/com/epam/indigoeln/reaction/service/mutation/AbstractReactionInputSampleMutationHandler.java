...
public abstract class AbstractReactionInputSampleMutationHandler<T extends ReactionInputSampleMutation, R extends MutationRedoInfo> extends ExperimentMutationHandlerBase<T, R> {
    ...
    protected abstract MutationResult handle(ExperimentEntity experiment, ExperimentModel model, Reaction reaction, ReactionInput row, ReactionInputSample sample, T mutation, @Nullable R redoInfo);
}
