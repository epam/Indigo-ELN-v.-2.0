...
public class BingoSubstructureMatchFunction extends AbstractSqmFunctionDescriptor {

    BingoSubstructureMatchFunction() {
        super("bingo_substructure_match");
    }
    ...
    protected <T> SelfRenderingSqmFunction<T> generateSqmFunctionExpression(List<? extends SqmTypedNode<?>> arguments, ReturnableType<T> impliedResultType, QueryEngine queryEngine) {
        ...
        return registry.patternDescriptorBuilder("bingo_substructure_match", "?1 @ (?2, ?3)::bingo.sub")
