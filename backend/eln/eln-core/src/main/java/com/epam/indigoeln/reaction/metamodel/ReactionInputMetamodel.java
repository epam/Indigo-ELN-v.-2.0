...
class ReactionInputMetamodel {
    ...
    public static final Metamodel<ReactionInput, ReactionInputPatch> INSTANCE = Metamodels.createMetamodel("ReactionInput", m -> {
        ...
        m.property("limiting", ReactionInput::isLimiting, ReactionInput::setLimiting, ReactionInputPatch::getLimiting, ReactionInputPatch::setLimiting, false);
        m.property("samples", ReactionInput::getSamples, ReactionInput::setSamples, ReactionInputPatch::getSamples, ReactionInputPatch::setSamples, new ListDiffHandler<>(ReactionInputSample::getAnchor, new MetamodelDiffHandler<>(ReactionInputSampleMetamodel.INSTANCE, ReactionInputSamplePatch::new)));
    });
}
