...
public class ReactionOutputMetamodel {
    ...
    public static final ModelProperty<ReactionOutput, Boolean, ReactionOutputPatch, Boolean> INTENDED = property("intended", ReactionOutput::isIntended, ReactionOutput::setIntended, ReactionOutputPatch::getIntended, ReactionOutputPatch::setIntended);
