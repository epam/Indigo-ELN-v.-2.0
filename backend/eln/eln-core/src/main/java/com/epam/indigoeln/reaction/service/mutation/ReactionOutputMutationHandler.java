...
public non-sealed interface ReactionOutputMutationHandler<T extends ReactionOutputMutation, R extends MutationRedoInfo> extends MutationHandler<T, R> {
    ...
    MutationResult handle(ExperimentEntity experiment, ExperimentModel model, Reaction reaction, ReactionOutput row, T mutation, @Nullable R redoInfo, MutationContext context);
