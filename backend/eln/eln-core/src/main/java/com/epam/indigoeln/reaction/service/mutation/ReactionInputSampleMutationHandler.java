...
public abstract class ReactionInputSampleMutationHandler<T extends ReactionInputSampleMutation, R extends MutationRedoInfo> extends AbstractMutationHandler<T, R> {
