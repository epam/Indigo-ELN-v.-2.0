...
public abstract class AbstractReactionOutputMutationHandler<T extends ReactionOutputMutation, R extends MutationRedoInfo> extends AbstractMutationHandler<T, R> {
