...
public class ExperimentMetamodel {
    ...
    public static final Metamodel<ExperimentSnapshot, ExperimentPatch> INSTANCE = Metamodels.createMetamodel("Experiment", m -> {
        m.property("title", ExperimentSnapshot::getTitle, ExperimentSnapshot::setTitle, ExperimentPatch::getTitle, ExperimentPatch::setTitle);
        ...
        m.property("literature", ExperimentSnapshot::getLiterature, ExperimentSnapshot::setLiterature, ExperimentPatch::getLiterature, ExperimentPatch::setLiterature);
        m.property("batchCreator", ExperimentSnapshot::getBatchCreator, ExperimentSnapshot::setBatchCreator, ExperimentPatch::getBatchCreator, ExperimentPatch::setBatchCreator);
