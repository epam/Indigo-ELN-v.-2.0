...
public class ExperimentMetamodel {
    ...
    public static final ModelProperty<ExperimentSnapshot, com.epam.indigoeln.common.model.UserRef> BATCH_CREATOR = property("batchCreator", ExperimentSnapshot::getBatchCreator, ExperimentSnapshot::setBatchCreator);
    ...
    public static final ModelProperty<ExperimentSnapshot, Boolean> DELETED = property("deleted", ExperimentSnapshot::getDeleted, ExperimentSnapshot::setDeleted);
    ...
    public static final ModelProperty<ExperimentSnapshot, Set<ACLDetailsEntryDTO>> ACL = property("acl", ExperimentSnapshot::getAcl, ExperimentSnapshot::setAcl);
