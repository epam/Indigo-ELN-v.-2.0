...
public class ReactionOutputSampleMetamodel {
    ...
    public static final ModelProperty<ReactionOutputSample, SampleSourceDetailsRef> SOURCE_DETAILS = property("sourceDetails", ReactionOutputSample::getSourceDetails, ReactionOutputSample::setSourceDetails);
    public static final ModelProperty<ReactionOutputSample, ComponentStateRef> COMPONENT_STATE = property("componentState", ReactionOutputSample::getComponentState, ReactionOutputSample::setComponentState);
