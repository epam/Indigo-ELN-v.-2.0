...
WHERE current_setting('eln.isContentEditor')::BOOLEAN OR pa.project_id IS NOT NULL;
...
WHERE current_setting('eln.isContentEditor')::BOOLEAN OR na.notebook_id IS NOT NULL;
...
WHERE current_setting('eln.isContentEditor')::BOOLEAN OR ea.experiment_id IS NOT NULL;
