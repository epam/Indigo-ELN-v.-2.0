...
class TemplateServiceTest extends BaseTest {
    ...
    void testCreateTemplateValidation() {
        assertThatClientCall(() -> templatesClient.createTemplate(new TemplateRequest(null)))
                .isBadRequest();
    }

    @Test
    void testCreateTemplate() {
        TemplateDetailsDTO template = templatesClient.createTemplate(new TemplateRequest("testCreateTemplate"));
    ...
    void testGetTemplate() {
        TemplateDetailsDTO createdTemplate = templatesClient.createTemplate(new TemplateRequest("testGetTemplate"));
    ...
    void testGetTemplates() {
        templatesClient.createTemplate(new TemplateRequest("testGetTemplates"));
    ...
    void testEditTemplate() {
        TemplateDetailsDTO template = templatesClient.createTemplate(new TemplateRequest("testEditTemplate"));
