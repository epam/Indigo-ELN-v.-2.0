...
public class ExperimentModelSerializationTest {
    ...
    void testSerialize() throws Exception {
        ...
        input1.setCompound(new CompoundRef.Stored(UUID.randomUUID(), EnteredValue.fixed(1.0, MolWeightUnit.G_PER_MOL), 1.1, "molFile", "C", new STRCodeCompound(1, 0)));
        ...
        input2.setCompound(new CompoundRef.Virtual(UUID.randomUUID(), "molFile", "C", 1.0, 1.1));
        ...
        output.setCompound(new CompoundRef.Virtual(UUID.randomUUID(), "molFile", "C", 2.0, 2.2));
