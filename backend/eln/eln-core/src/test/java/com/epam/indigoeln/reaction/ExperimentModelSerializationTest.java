...
public class ExperimentModelSerializationTest {
    ...
    void testSerialize() throws Exception {
        ...
        input1.setCompound(new CompoundRef.Stored(UUID.randomUUID(), EnteredValue.fixed(1.0, 1, MolWeightUnit.G_PER_MOL), 1.1, "C", "compoundKey", null, "batchMF"));
        ...
        input2.setCompound(new CompoundRef.Virtual(UUID.randomUUID(), "C", null, null, null, null, EnteredValue.fixed(1.0, 1, MolWeightUnit.G_PER_MOL), 1.1, null, "batchMF"));
        ...
        output.setCompound(new CompoundRef.Virtual(UUID.randomUUID(), "C", null, null, null, null, EnteredValue.fixed(2.0, 1, MolWeightUnit.G_PER_MOL), 2.2, null, "batchMF"));
