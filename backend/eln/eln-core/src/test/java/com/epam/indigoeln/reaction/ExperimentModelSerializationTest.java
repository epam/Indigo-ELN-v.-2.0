...
public class ExperimentModelSerializationTest {
    ...
    void testSerialize() {
        ...
        input1.setCompound(new CompoundRef.Stored(UUID.randomUUID(), "realCompound", EnteredValue.fixed(1.0, MolWeightUnit.G_PER_MOL), "molFile", "C", new STRCodeCompound(1, 0).toString()));
