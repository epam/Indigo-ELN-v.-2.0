...
import { ExperimentItemComponent } from '@/core/components/notebook/experiment-item/experiment-item.component';
...
@Component({
  selector: 'eln-notebook-experiments-tab',
  templateUrl: './experiments-tab.component.html',
  standalone: true,
  animations: [
    trigger('viewChange', [
