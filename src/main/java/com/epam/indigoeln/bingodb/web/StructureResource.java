...
public class StructureResource {
    ...
    public ResponseEntity<ResponseDTO> insert(@RequestBody String s) {
        try {
            ...
            LOGGER.warn("Cannot insert structure: " + e.getMessage());
        }
    ...
    public ResponseEntity<ResponseDTO> update(@PathVariable String id, @RequestBody String s) {
        try {
            ...
            LOGGER.warn("Cannot update structure with id=" + id + ": " + e.getMessage());
        }
    ...
    public ResponseEntity<ResponseDTO> delete(@PathVariable String id) {
        try {
            ...
            LOGGER.warn("Cannot delete structure with id=" + id + ": " + e.getMessage());
        }
    ...
    public ResponseEntity<ResponseDTO> getById(@PathVariable String id) {
        try {
            ...
            LOGGER.warn("Cannot load structure with id=" + id + ": " + e.getMessage());
        }
