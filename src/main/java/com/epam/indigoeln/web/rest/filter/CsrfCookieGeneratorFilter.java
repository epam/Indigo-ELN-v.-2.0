...
import com.epam.indigoeln.core.security.CookieConstants;
...
public class CsrfCookieGeneratorFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (actualToken == null || !actualToken.equals(csrfToken.getToken())) {
            ...
            Cookie cookie = new Cookie(pCookieName, csrfToken.getToken()); //NOSONAR: it is highly possible that application will be used over http protocol only
            cookie.setMaxAge(-1);
