...
public class BatchModel extends CeNAbstractModel implements Comparable<BatchModel>, StoicModelInterface {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(autoCalcOn, that.autoCalcOn)
                .append(inCalculation, that.inCalculation)
                .append(limiting, that.limiting)
                .append(transactionOrder, that.transactionOrder)
                .append(lastUpdatedType, that.lastUpdatedType)
                .append(previousMolarAmount, that.previousMolarAmount)
                .append(compound, that.compound)
                .append(molecularWeightAmount, that.molecularWeightAmount)
                .append(moleAmount, that.moleAmount)
                .append(weightAmount, that.weightAmount)
                .append(loadingAmount, that.loadingAmount)
                .append(volumeAmount, that.volumeAmount)
                .append(densityAmount, that.densityAmount)
                .append(molarAmount, that.molarAmount)
                .append(purityAmount, that.purityAmount)
                .append(rxnEquivsAmount, that.rxnEquivsAmount)
                .append(totalVolume, that.totalVolume)
                .append(totalWeight, that.totalWeight)
                .append(totalMolarity, that.totalMolarity)
                .append(batchType, that.batchType)
                .append(precursors, that.precursors)
                .isEquals();
    }
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37)
                ...
                .append(previousMolarAmount)
                .append(autoCalcOn)
                .append(inCalculation)
                .append(compound)
                .append(molecularWeightAmount)
                .append(moleAmount)
                .append(weightAmount)
                .append(loadingAmount)
                .append(volumeAmount)
                .append(densityAmount)
                .append(molarAmount)
                .append(purityAmount)
                .append(rxnEquivsAmount)
                .append(totalVolume)
                .append(totalWeight)
                .append(totalMolarity)
                .append(limiting)
                .append(batchType)
                .append(precursors)
                .append(transactionOrder)
                .append(lastUpdatedType)
                .toHashCode();
    }
