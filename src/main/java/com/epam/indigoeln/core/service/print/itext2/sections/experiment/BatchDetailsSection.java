...
public class BatchDetailsSection extends BasePdfSectionWithSimpleTitle<BatchDetailsModel> {
    ...
    protected PdfPTable generateContentTable(float width) {
        ...
        pdfPTableHelper.addKeyValueCellsNoBold("Registered Date", model.getRegistrationDate());
        ...
        pdfPTableHelper.addKeyValueCellsNoBold("Calculated Batch MW", model.getMolWeight());
