angular.module('indigoeln',
    ...
    .run(function($rootScope, $window, $state, $uibModal, editableOptions, Auth, Principal, Idle, EntitiesBrowser, $http, $cookies, PdfService) {
        ...
        // setTimeout(function() {
        //     var html = $('#for-print1').html()
        //     html = '<!DOCTYPE html><html><body>' + html + '</body>';
        //     PdfService.create({
        //         html: html,
        //         //header: header,
        //         fileName: 'test'
