...
angular.module('indigoeln')
    .directive('msgAlert', function (AlertService) {
        return {
            restrict: 'E',
    ...
    .directive('msgAlertError', function (AlertService, $rootScope) {
        return {
            restrict: 'E',
            template: '<div class="alerts" ng-cloak="">' +
            '<div ng-repeat="alert in alerts" ng-class="[alert.position, {\'toast\': alert.toast}]">' +
            ...
            controller: ['$scope',
                function ($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('indigoeln.httpError', function (event, httpResponse) {
                        var i;
