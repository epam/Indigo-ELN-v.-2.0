        ...
        link : function(scope, elem, attrs) {
            ...
            scope.$on('experiment-open', function(event, data) {
            	...
            	if (openedTab.length > 0) {
                    ...
                    scope.tabs.push({ experiment : data.experiment, active : true, content : 'scripts/app/entities/experiment/tabs/experiment-tab.html', name : data.experiment.name});
                }
            ...
            function newExperiment() {
                scope.tabs.push({active : true, content : 'scripts/app/entities/experiment/tabs/new-experiment-tab.html', name : 'New experiment'});
            }
