(function () {
    ...
    /* @ngInject */
    function controller($scope, $rootScope, $http, $q, $uibModal, $log, AppValues, AlertModal, Alert, Dictionary, CalculationService, SearchService, RegistrationService, DialogService, StoichTableCache, $timeout) {
