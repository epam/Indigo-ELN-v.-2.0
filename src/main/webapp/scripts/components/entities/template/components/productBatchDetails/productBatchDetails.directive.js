(function () {
    ...
    /* @ngInject */
    function controller($scope, $uibModal, AlertModal, AppValues, InfoEditor, $timeout, CalculationService, ProductBatchSummaryCache, $filter, StoichTableCache, $rootScope, ProductBatchSummaryOperations, EntitiesBrowser) {
