...
angular.module('indigoeln')
    ...
    }]).directive('hasAnyAuthorityExcept', ['Principal', function (Principal) {
    return {
        restrict: 'A',
        link: function (scope, element, attrs) {
            var setVisible = function () {
                ...
                defineVisibility = function (reset) {
                    ...
                    Principal.hasAnyAuthorityExcept(authority)
                        .then(function (result) {
                            if (result) {
                                setVisible();
                            } else {
                ...
                authority = attrs.hasAnyAuthorityExcept.replace(/\s+/g, '');
