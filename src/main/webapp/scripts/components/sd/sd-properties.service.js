    ...
    var constants = [
        ...
        },
        {
            ...
            import : {name: 'purity',
                      ...
                      format: function (dicts, value) {
                                   return {
                                       data : { 2 : {value: parseInt(value)}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_3_COMENTS',
                      prop: ['purity', 'data', '3', 'comments']},
            import : {name: 'purity',
                      code: 'PURITY_3_COMENTS',
                      format: function (dicts, value) {
                                   return {
                                       data : { 3 : {comments: value}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_3_DETERMINED',
                      prop: ['purity', 'data', '3', 'determinedBy']},
            import : {name: 'purity',
                      code: 'PURITY_3_DETERMINED',
                      format: function (dicts, value) {
                                   return {
                                       data : { 3 : {determinedBy: value}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_3_OPERATOR_NAME',
                      prop: ['purity', 'data', '3', 'operator', 'name']},
            import : {name: 'purity',
                      code: 'PURITY_3_OPERATOR_NAME',
                      format: function (dicts, value) {
                                   return {
                                       data : { 3 : {operator: {name: value}}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_3_VALUE',
                      prop: ['purity', 'data', '3', 'value']},
            import : {name: 'purity',
                      code: 'PURITY_3_VALUE',
                      format: function (dicts, value) {
                                   return {
                                       data : { 3 : {value: parseInt(value)}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_4_COMENTS',
                      prop: ['purity', 'data', '4', 'comments']},
            import : {name: 'purity',
                      code: 'PURITY_4_COMENTS',
                      format: function (dicts, value) {
                                   return {
                                       data : { 4 : {comments: value}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_4_DETERMINED',
                      prop: ['purity', 'data', '4', 'determinedBy']},
            import : {name: 'purity',
                      code: 'PURITY_4_DETERMINED',
                      format: function (dicts, value) {
                                   return {
                                       data : { 4 : {determinedBy: value}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_4_OPERATOR_NAME',
                      prop: ['purity', 'data', '4', 'operator', 'name']},
            import : {name: 'purity',
                      code: 'PURITY_4_OPERATOR_NAME',
                      format: function (dicts, value) {
                                   return {
                                       data : { 4 : {operator: {name: value}}}
                                   };
                               }
                      }
        },
        {
            export : {name: 'PURITY_4_VALUE',
                      prop: ['purity', 'data', '4', 'value']},
            import : {name: 'purity',
                      code: 'PURITY_4_VALUE',
                      format: function (dicts, value) {
                                   return {
                                       data : { 4 : {value: parseInt(value)}}
                                   };
                               }
                      }
        },
        ...
        {
            export : {name: 'MELTING_POINT_COMMENTS',
        ...
        {
            export : {name: 'MELTING_POINT_LOWER',
            ...
            export : {name: 'MELTING_POINT_UPPER',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_STRING',
                      prop: ['residualSolvents', 'asString']},
            import : {name: 'residualSolvents',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_0_COMMENT',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_0_EQ',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_0_RANK',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_0_NAME',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_1_COMMENT',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_1_EQ',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_1_RANK',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_1_NAME',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_2_COMMENT',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_2_EQ',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_2_RANK',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_2_NAME',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_3_COMMENT',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_3_EQ',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_3_RANK',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_3_NAME',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_4_COMMENT',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_4_EQ',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_4_RANK',
        ...
        {
            export : {name: 'RESIDUAL_SOLVENTS_4_NAME',
                      prop: ['residual', 'data', '4', 'name', 'name']},
            import : {name: 'residual',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_STRING',
                      prop: ['solubility', 'asString']},
            import : {name: 'solubility',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_COMMENT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_TYPE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_RANK',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_ENABLE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_VALUE_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_VALUE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_VALUE_OPERATOR',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_0_VALUE_UNIT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_COMMENT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_TYPE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_RANK',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_ENABLE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_VALUE_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_VALUE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_VALUE_OPERATOR',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_1_VALUE_UNIT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_COMMENT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_TYPE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_RANK',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_ENABLE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_VALUE_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_VALUE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_VALUE_OPERATOR',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_2_VALUE_UNIT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_COMMENT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_TYPE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_RANK',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_ENABLE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_VALUE_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_VALUE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_VALUE_OPERATOR',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_3_VALUE_UNIT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_COMMENT',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_TYPE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_RANK',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_ENABLE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_VALUE_NAME',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_VALUE',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_VALUE_OPERATOR',
        ...
        {
            export : {name: 'SOLUBILITY_SOLVENTS_4_VALUE_UNIT',
        ...
        {
            export : {name: 'EXTERNAL_SUPPLIER_STRING',
                      prop: ['externalSupplier', 'asString']},
            import : {name: 'externalSupplier',
        ...
        {
            export : {name: 'EXTERNAL_SUPPLIER_REG_NUMBER',
        ...
        {
            export : {name: 'EXTERNAL_SUPPLIER_CODE_AND_NAME',
        ...
        {
            export : {name: 'COMPOUND_PROTECTION',
                      prop: ['compoundProtection', 'name']},
            import : {name: 'compoundProtection',
        ...
        {
            export : {name: 'HEALTH_HAZARDS_STRING',
                      prop: ['healthHazards', 'asString']},
            import : {name: 'healthHazards',
        ...
        {
            export : {name: 'HANDLING_PRECAUTIONS_STRING',
                      prop: ['handlingPrecautions', 'asString']},
            import : {name: 'handlingPrecautions',
        ...
        {
            export : {name: 'HANDLING_PRECAUTIONS_0',
        ...
        {
            export : {name: 'HANDLING_PRECAUTIONS_1',
        ...
        {
            export : {name: 'HANDLING_PRECAUTIONS_2',
        ...
        {
            export : {name: 'HANDLING_PRECAUTIONS_3',
        ...
        {
            export : {name: 'HANDLING_PRECAUTIONS_4',
        ...
        {
            export : {name: 'STORAGE_INSTRUCTIONS_STRING',
                      prop: ['storageInstructions', 'asString']},
            import : {name: 'storageInstructions',
        ...
        {
            export : {name: 'STORAGE_INSTRUCTIONS_0',
        ...
        {
            export : {name: 'STORAGE_INSTRUCTIONS_1',
        ...
        {
            export : {name: 'STORAGE_INSTRUCTIONS_2',
        ...
        {
            export : {name: 'STORAGE_INSTRUCTIONS_3',
