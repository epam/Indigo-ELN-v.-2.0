    ...
    function IndigoStoichTableController($scope, $rootScope, $q, $uibModal, appValues, stoichColumnActions,
            ...
            getMissingReactionReactantsInStoic(vm.infoReactants).then(function(batchesToSearch) {
                if (batchesToSearch && batchesToSearch.length) {
                    $uibModal.open({
                        ...
                        controllerAs: 'vm',
                        templateUrl: 'scripts/app/common/components/indigo-components/common/analyze-rxn/analyze-rxn.html',
                        resolve: {
                            reactants: function() {
        ...
        function searchReagents(activeTab) {
            $uibModal.open({
                ...
                controllerAs: 'vm',
                templateUrl: 'scripts/app/common/components/indigo-components/common/search-reagents/search-reagents.html',
                resolve: {
                    activeTab: function() {
                        return activeTab;
                    }
