...
function infoEditor($uibModal) {
    ...
    function editSolubility(solubility, callback) {
        return $uibModal.open({
            ...
            controllerAs: 'vm',
            templateUrl: 'scripts/indigo-components/common/edit-info-popup/edit-solubility/edit-solubility.html',
            resolve: {
                solubility: function() {
                    return solubility;
                }
    ...
    function editResidualSolvents(residualSolvents) {
        return $uibModal.open({
            ...
            controllerAs: 'vm',
            templateUrl: 'scripts/indigo-components/common/edit-info-popup/edit-residual-solvents/edit-residual-solvents.html',
            resolve: {
                solvents: function() {
    ...
    function editExternalSupplier(data, callback) {
        $uibModal.open({
            ...
            controllerAs: 'vm',
            templateUrl: 'scripts/indigo-components/common/edit-info-popup/edit-external-supplier/edit-external-supplier.html',
            resolve: {
                data: function() {
                    return data;
                }
    ...
    function editMeltingPoint(data, callback) {
        $uibModal.open({
            ...
            controllerAs: 'vm',
            templateUrl: 'scripts/indigo-components/common/edit-info-popup/edit-melting-point/edit-melting-point.html',
            resolve: {
                data: function() {
                    return data;
                }
    ...
    function editPurity(data, callback) {
        $uibModal.open({
            ...
            controllerAs: 'vm',
            templateUrl: 'scripts/indigo-components/common/edit-info-popup/edit-purity/edit-purity.html',
            resolve: {
                data: function() {
                    return data;
                },
    ...
    function selectFromDictionary(dictionary, model, title, callback) {
        $uibModal.open({
            ...
            controllerAs: 'vm',
            templateUrl: 'scripts/indigo-components/common/edit-info-popup/select-from-dictionary/select-from-dictionary.html',
            resolve: {
                data: function() {
                    return model;
                },
