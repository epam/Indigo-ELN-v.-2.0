...
/**
 * Common superclass for all signature related exceptions
 * 
 * @author dzhelezov
 *
 */
public class SignatureException extends IndigoSignatureServiceException {
	private static final long serialVersionUID = -8319537359794462545L;
