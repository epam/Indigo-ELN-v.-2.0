...
public class FtpArchiver implements Archiver {
    @Override
    public void archiveDocument(Document document, DatabaseConnector database) {
        database.queueForFtp(document.getId());
    }
}
